fn main() {
    ...
    if std::env::var("CARGO_CFG_TARGET_OS").as_deref() == Ok("windows") {
        ...
        res.set_version_info(winresource::VersionInfo::FILEVERSION, 0x0001000000060000);
        res.set_version_info(winresource::VersionInfo::PRODUCTVERSION, 0x0001000000060000);
